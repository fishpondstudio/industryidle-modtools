   ...
   render() {
      ...
      return (
         <table>
            <tr>
               <th>
                  <a href="https://api.fishpondstudio.com/leaderboard/v4?name=byAllPrestigeCurrency" target="_blank">
                     Reload
                  </a>
               </th>
                        ...
                        return (
                           <>
                              <td
                                 title={
                                    current
                                       ? `Rank: ${nf(current.rank)}, Swiss Money: ${nf(current.allPrestigeCurrency)}`
                                       : "N/A"
                                 }
                                 class={
                                    current &&
